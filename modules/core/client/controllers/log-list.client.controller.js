...
angular.module('node').controller('nodeListController', ['$scope', '$state', 'logger', '$location', '$window', 'Authentication', 'nodeService',
    function ($scope, $state, logger, $location, $window, Authentication, nodeService) {
